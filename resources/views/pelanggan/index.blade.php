...
@section('content')
    ...
    <table class="table table-bordered table-hover">
        @if ($rows->isEmpty())
            <h4 class="mt-5 text-center text-light">Tidak Ada Data Pelanggan.<br> Harap Masukkan Data terlebih dahulu</h4>
        @else
            ...
            @foreach ($rows as $row)
                <tr class="table-light">
                    ...
                    <td class="text-center">{{ $row->hairstyle->style_name }}</td>
                    ...
                    <td class="text-center">{{ $row->hairstyle->style_harga }}</td>
